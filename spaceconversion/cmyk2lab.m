function Lab = cmyk2lab(cmyk, use_cielab, cmyk_space)
...
if use_cielab
    ...
    Lab = applycform(cmyk, makecform('icc', P_cmyk, P_uplab));
else
    Lab = applycform(cmyk, makecform('CLUT', P_cmyk, 'AToB0')); % Pick one of BToA0, BToA1, BToA2
end
